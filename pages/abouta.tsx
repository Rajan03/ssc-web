...
const About = () => {
      ...
      <div className=" md:ml-[15%] flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 ml-10">
          <div className="relative md:w-[600px] md:mr-5  md:mt-[95%]">
            ...
            <h1 className="relative mx-4 md:mx-20 mb-7 text-4xl font-bold text-red-500">
              ABOUT OUR COMPANY
            </h1>
            <h2 className="relative mx-4 md:mx-20 mb-7 text-4xl font-medium text-black">
              Find Out More About Our Business Consulting
            </h2>
            <p className="relative mx-4 md:mx-20 mb-20 ml-4 md:ml-20 text-2xl text-justify font-medium text-black">
  ...
  <div className="w-full md:w-1/2 ml-10">
    <div className="relative md:w-[600px] md:mt-[20%]">
      ...
      <h2 className="relative mx-4 md:mx-20 mb-7 text-4xl font-bold text-black">
      ...
      <span className='font-medium text-xl ml-10'>Project Completed Last Year</span>
      <span className="mb-2 text-4xl ml-20 font-bold text-black">{count}k</span>
      <span className='font-medium text-xl ml-10'>Happy Customer Worlwide</span>
...
<div className="relative md:h-[300px] mt-5">
      <img
        ...
        alt="Image 1"
        className="object-cover h-full w-full  filter grayscale"></img>
