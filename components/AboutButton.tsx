...
const HoverButton: React.FC<HoverButtonProps> = ({ text }) => {
  return (
    <div className="group">
      ...
      >
        <span className="absolute top-0 left-0 w-0 h-0 transition-all duration-500 ease-out bg-red-500 rounded group-hover:w-full group-hover:h-full -z-1 border-radius-5"
        ></span>
