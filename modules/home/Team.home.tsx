...
const Teams: React.FC<SanityTeamsHome> = ({ title, subtitle, coaches }) => {
  return (
    <section className="container mx-auto relative flex flex-col justify-start items-center sm:items-stretch px-8 pb-20 pt-40">
      ...
      {/* Team Cards - 4 Only */}
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8 mt-16">
        {coaches?.map((coach) => (
